...
// Ambil data penangkaran dari database
        ...
        <div class="container">
            <div class="row g-5 align-items-end mb-5">
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="border-start border-5 border-primary ps-2">
                        <h1 class="display-6 mb-0">Lacak Keturunan Merpati</h1>
                    </div>
                </div>
            </div>
            <div class="row g-4 justify-content-center">
                ...
                while ($row = mysqli_fetch_assoc($result)) {
                    ...
                    echo '<img class="img-fluid" src="img/service-1.jpg" alt="Image">';
                    echo '<div class="service-text position-relative text-center h-100 p-4">';
                    echo '<h5 class="mb-3">' .'Penangkaran '. $row['nama'] . '</h5>';
                    echo '<a class="small" href="tampilanbloodline.php?id=' . $row['id_anggota'] . '">Lihat Lebih</a>';
                    echo '</div>';
                    echo '</div>';
                    echo '</div>';
                }
